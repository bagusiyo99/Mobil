...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html">Sewa<span>Mobil</span></a>
    ...
    <script>
        ...
        flatpickr("#tgl-boking", {
            enableTime: false, // Untuk tanggal saja, tanpa waktu
            dateFormat: "Y-m-d", // Format tanggal yang sesuai dengan kolom database
        });
    </script>
